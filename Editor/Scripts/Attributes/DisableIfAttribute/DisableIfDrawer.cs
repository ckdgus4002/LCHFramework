...
namespace LCHFramework.Editor.Attributes
{
    ...
    public class DisableIfDrawer : PropertyDrawer
    {
        public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
        {
            ...
            DisableIfAttribute condHAtt = (DisableIfAttribute)attribute;
            bool enabled = GetDisableIfAttributeResult(condHAtt, property);        
        ...
        private bool GetDisableIfAttributeResult(DisableIfAttribute condHAtt, SerializedProperty property)
        {
